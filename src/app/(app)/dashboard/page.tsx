...
function UserDashboard() {
  ...
  return (
    <div className="my-8 mx-4 md:mx-8 lg:mx-auto p-6 bg-white rounded w-full max-w-6xl">
      <h1 className="text-4xl text-green-500 text font-bold mb-4">User Dashboard</h1>

      <div className="mb-4">
        <h2 className="text-lg text-amber-400 font-semibold mb-2">Copy Your Unique Link</h2>
      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6">
        {messages.length > 0 ? (
          messages.map((message) => (
            <MessageCard key={String(message._id)} message={message} onMessageDeleteAction={handleDeleteMessageAction} />
          ))
        ) : (
